...
(async () => {
  try {
    ...
    const n = path.join(projectPath, 'tailwind.config.js'),
      e =
        "module.exports = {\n  content: ['./src/**/*.{js,jsx,ts,tsx}', './index.html'],\n  theme: {},\n  plugins: [],\n};\n";
    fs.writeFileSync(n, e);
    const s = path.join(projectPath, 'src', 'App.tsx'),
      t =
    ...
    const a = path.join(projectPath, 'src', 'App.css');
    fs.writeFileSync(a, '');
    const c = path.join(projectPath, 'src', 'index.css'),
      i = '@tailwind base;\n@tailwind components;\n@tailwind utilities;\n';
    fs.writeFileSync(c, i),
      console.log(
